...
public class SixthQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.setWebViewClient(new SixthQuestionActivity.MyWebViewClient());
        ...
        String url = "https://drive.google.com/drive/folders/0B3ALScOazGkadXRGTWZja1JhclE?usp=sharing";
        webview.loadUrl(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent i=new Intent(SixthQuestionActivity.this, AboutUsActivity.class);
            startActivity(i);
            return true;
        }
