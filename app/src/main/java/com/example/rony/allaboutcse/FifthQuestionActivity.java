...
public class FifthQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.setWebViewClient(new FifthQuestionActivity.MyWebViewClient());
        ...
        String url = "https://drive.google.com/drive/folders/0B3ALScOazGkaQWJxMHRoMTRNcVU?usp=sharing";
        webview.loadUrl(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent i=new Intent(FifthQuestionActivity.this, AboutUsActivity.class);
            startActivity(i);
            return true;
        }
