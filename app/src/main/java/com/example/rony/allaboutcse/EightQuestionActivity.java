...
public class EightQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.setWebViewClient(new EightQuestionActivity.MyWebViewClient());
        ...
        String url = "https://drive.google.com/drive/folders/0B3ALScOazGkaRG9DSE5zOUpscWM?usp=sharing";
        webview.loadUrl(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent i=new Intent(EightQuestionActivity.this, AboutUsActivity.class);
            startActivity(i);
            return true;
        }
