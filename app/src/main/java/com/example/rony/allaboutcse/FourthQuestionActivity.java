...
public class FourthQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.setWebViewClient(new FourthQuestionActivity.MyWebViewClient());
        ...
        String url = "https://drive.google.com/drive/folders/0B3ALScOazGkaTFI4SnZ6UzdoeEk?usp=sharing";
        webview.loadUrl(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent i=new Intent(FourthQuestionActivity.this, AboutUsActivity.class);
            startActivity(i);
            return true;
        }
